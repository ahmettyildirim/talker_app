...
class RoomListTab extends StatefulWidget {
  const RoomListTab({Key key, this.scaffoldKey, this.tabItem, this.onlyMyRoom=false})
      : super(key: key);
    ...
    return Semantics(
      ...
      child: Dismissible(
        ...
        child: Container(
          ...
          child: ListData(
              title: snapShot["name"],
              subtitle:  '${snapShot["users"].length.toString()} user${snapShot["users"].length > 1 ? 's are' : ' is'} online in this room',
