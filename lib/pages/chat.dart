...
class ChatScreenState extends State<ChatScreen> {
  ...
  Widget buildItem(int index, dynamic document) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: senderId == _currentUser.uid ? CrossAxisAlignment.end : CrossAxisAlignment.start,
        children: [
          showAvatar(index) ? photoLayout(message,senderId == _currentUser.uid) : Container(),
  ...
  Widget messageLayout(ConversationModel model,bool isLeft){
    ...
    Container(
      constraints: BoxConstraints(
        ...
        //       child: Container(
        //         child: Text(
        //           "${model.timestamp.hour}:${model.timestamp.minute}",
        //           textAlign: TextAlign.right,
        //           style: TextStyle(color: Colors.grey),
        //         ),
        //       ),
        ...
        Row(
          ...
          children: <Widget>[
            Container(
                ...
                child: Text(model.sender,style: TextStyle(color: Color(0xfff2f2f2)),)
              ),
              Container(
                      margin: new EdgeInsets.only(
                      ...
                      decoration: new BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: isRight ? NetworkImage(_currentUser.photoUrl) : ExactAssetImage('assets/user.png') , 
                            fit: BoxFit.cover,
                          ))
              ),
          ],
    ...
    return Column(
      ...
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(
            boxShadow: [
              BoxShadow(blurRadius: .5, spreadRadius: 1.0, color: Colors.black)
            ],
            color: bg,
            borderRadius: radius,
          ),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Bubble(
              message:
                  'Nice one, Flutter is awesome Nice one, Flutter is awesome Nice one, Flutter is awesome Nice one, Flutter is awesome Nice one, Flutter is awesome Nice one, Flutter is awesome Nice one, Flutter is awesome Nice one, Flutter is awesome Nice one, Flutter is awesome ',
              time: '12:00',
              delivered: true,
              isMe: true,
            ),
